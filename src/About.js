  ...
  return (
    <div className="About">
      ...
      <div className="About-details">
        ...
        <p>
          A Philly-based software engineer with 15 years of development experience, a passion for learning new technologies, and a keen interest in web standards and building fast pixel-perfect interfaces. 9 years in the Ecommerce industry has provided me with vast knowledge to develop the integral components that make up the online shopping experience.
        </p>
      </div>
    </div>
  )
