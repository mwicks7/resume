...
import sedsoCMS from './images/sedso_content_manager.jpg'
function Article () {
  return (
    <article className="Lab-project">
      <div className="Lab-image">
        <img height="300" width="300" alt="The Table of Fifths preview" src={fifthsImage} />
      </div>
...
function Lab () {
  return (
    <div className="Lab">
      ...
      <article className="Lab-project">
        <div className="Lab-image">
          <img alt="SEDSO Content Management System preview" src={sedsoCMS} />
        </div>
        <div className="Lab-description">
          <h3 className="Lab-name">SEDSO Content Management System</h3>
          <p>
